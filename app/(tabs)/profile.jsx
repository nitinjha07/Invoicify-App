    ...
    return (
      <SafeAreaView className="bg-primary h-full">
        <View className="w-full flex justify-center items-center mt-6 mb-12 px-4 z-2">
          ...
          >
            <Text className="text-secondary font-pbold">LogOut</Text>
            <Image
              source={icons.logout}
              resizeMode="contain"
        ...
        <View className="flex-1 mt-8 justify-center items-center bg-primary">
          <View className="mt-2 w-32 h-32 rounded-full overflow-hidden border border-gray-300 mb-4">
            <Image
              source={{
                uri: "https://www.pngitem.com/pimgs/m/150-1503945_transparent-user-png-default-user-image-png-png.png",
              }} // Replace with your image source
              style={styles.profileImage}
            />
          </View>
          <Text className="text-lg font-pbold text-secondary">
            Your Profile
          </Text>
          <Text className="text-lg font-pbold text-secondary w-[70%] text-center mt-10">
            Ready to leave? Click the button above to log out
          </Text>
        </View>
      </SafeAreaView>
    );
